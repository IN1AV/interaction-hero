...
class Hitbox(pygame.sprite.Sprite):
    ...
    def drop_new_note(self, music_player_ref, note, move_speed=10):
        self.notes.append(FallingNote(self.lane_index, self.allsprites, music_player_ref, note, move_speed=move_speed))
